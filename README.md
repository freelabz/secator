...
| [opensquat](https://github.com/atenreiro/opensquat)                                                       | openSquat is an opensource Intelligence (OSINT) security tool to identify cyber squatting threats. | `dns/recon/squatting` |
...
| [sshaudit](None)                                                        | SSH server & client security auditing (banner, key exchange, encryption, mac, compression, etc). | `ssh/audit/security` |
