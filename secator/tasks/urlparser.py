...
class urlparser(PythonRunner):
    ...
    opts = {
        'include': {
            'type': list,
            'default': ['url_root', 'url_base', 'url_query', 'url_param'],
