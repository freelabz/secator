...
from secator.definitions import (DELAY, DEPTH, FILTER_CODES, FILTER_REGEX,
							   ...
							   HEADER, IN_SCOPE, MATCH_CODES, MATCH_REGEX, MATCH_SIZE,
							   MATCH_WORDS, OPT_NOT_SUPPORTED,
							   OPT_PIPE_INPUT, OUT_OF_SCOPE, PROXY, RATE_LIMIT, RETRIES,
...
class cariddi(HttpCrawler):
	...
	opt_key_map = {
		...
		IN_SCOPE: OPT_NOT_SUPPORTED,
		MATCH_CODES: OPT_NOT_SUPPORTED,
		MATCH_REGEX: OPT_NOT_SUPPORTED,
		MATCH_SIZE: OPT_NOT_SUPPORTED,
		MATCH_WORDS: OPT_NOT_SUPPORTED,
		OUT_OF_SCOPE: OPT_NOT_SUPPORTED,
		PROXY: 'proxy',
