...
CLI_GLOBAL_OPTS = {
	'driver': {'type': click.Choice(['mongodb', 'gcs']), 'help': 'Drivers to export results in real time.'},
	'profiles': {'type': click.Choice([p.name for p in get_configs_by_type('profile')]), 'default': 'default', 'help': 'Profiles to load options sets', 'short': 'pf'},  # noqa: E501
	'workspace': {'type': str, 'default': 'default', 'help': f'Workspace (existing: [dim yellow3]{next(os.walk(CONFIG.dirs.reports))[1]}[/])', 'short': 'ws'},  # noqa: E501
